...
mkdir(saveDir);
    ...
    switch (specPlot-2)
        case 6
            ...
            freqRange = [4,8];
            clims = [0 mean(mean(HHData.ML.thetaSpectrum(:,:,channelIndex)))];
        case 5
...
HHData.Data.LFP.Spectrum = HHData.Data.LFP.Spectrum;
    ...
    freq = linspace(parameters.Choices.stftMin,parameters.Choices.stftMax,size(HHData.Data.LFP.Spectrum,1));
