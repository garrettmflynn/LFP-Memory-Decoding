function [orderedClusters] = clusterOrder_Matrix_WithPriority(countAcrossIters)
...
maxIter = 2; % Start at 2 to skip trials make trials with themselves AND another
%% Fill Edges Cell until 5 Stable Links are Made

[~,clusters] = numClusters_ForPriority(edges);
